...
import 'package:benex/UI/pages/Signup/singUp.dart';
...
class _IntroScreenOnboardingState extends State<IntroScreenOnboarding> {
  ...
  loadImgs() async {
    Future.wait([
      precachePicture(
        ExactAssetPicture(
            SvgPicture.svgStringDecoderBuilder, 'assets/svgs/intro1.svg'
      ...
      precachePicture(
        ExactAssetPicture(
            SvgPicture.svgStringDecoderBuilder, 'assets/svgs/intro2.svg'
            /*SvgPicture.svgStringDecoderBuilder, // See UPDATE below!
          'assets/svgs/intro1.svg',*/
            ),
        null,
