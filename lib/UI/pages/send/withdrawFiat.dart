                      ...
                      child: Column(
                        children: [
                          ...
                          InputFields(
                            ...
                            hintText:
                                appController.user.value.accountName ?? '',
                            suffixIcon: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                GestureDetector(
                          ...
                          Row(
                            children: [
                              Text(
                                "Available ${appController.user.value.currency?.symbol}${formatter2.format(num.parse(UtilService().toFixed2DecimalPlaces((appController.userBalance.value.wallet?.currentSwappedBalance ?? 0).toString(), decimalPlaces: 4)))}",
                                style: TextStyle(
                                  color: headingColor.value,
                                  fontSize: 10,
                          ...
                          BottomRectangularBtn(
                            ...
                            onTapFunc: () {
                              if (appController.withdrawFiatLoader.value ==
                                  false) {
    ...
    if (bankNameController.text.trim() == '') {
      ...
      ApiService()
          .withdrawFiat(
              ...
              amount: amountFiatController.text)
          .then((value) {
        if (value == 'OK') {
          //Get.back();
          //Get.to(TransactionCompleted());
          UtilService().showToast('Transaction Successful!',
              color: const Color(0xFF00D339));
          ...
          UtilService()
              .showToast('Transaction Failed!', color: redCardColor.value);
        }
        ...
        if (appController.getFeeLoader.value == false &&
          ...
          userGets.value = (num.parse(amountFiatController.text) -
                  (num.parse(amountFiatController.text) *
                      ((appController
                                  .platFormFeeList[appController.platFormFeeList
                                      .indexWhere((element) =>
                                          element.feeName ==
                                          'withdraw_fiat_fee')]
                                  .feePercentage ??
