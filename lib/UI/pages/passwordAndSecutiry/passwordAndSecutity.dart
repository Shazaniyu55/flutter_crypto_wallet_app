// ignore_for_file: file_names, prefer_const_constructors_in_immutables, empty_catches, use_super_parameters
...
class _PasswordAndSecurityState extends State<PasswordAndSecurity> {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Switch(
                              ...
                              inactiveThumbColor: appController.isDark.value
                      ...
                      children: [
                        BottomRectangularBtn(
                          ...
                          btnTitle: widget.fromPage == 'Settings'
                              ? 'Update Password'
                              : widget.fromPage == 'Import'
                                  ? 'Import Wallet'
                                  : 'Create Wallet',
                          loadingText: widget.fromPage == 'Import'
                              ? 'Importing Wallet...'
                              : 'Creating Wallet...',
                          isLoading: widget.fromPage == 'Import'
                              ? appController.registerWithImportLoader.value
                              : appController.registerLoader.value,
                        ),
                        const SizedBox(
                          height: 45,
                        )
  ...
  verifyPass() async {
    if (passController.text.length < 8) {
      ...
      await ApiService()
          .register(name: widget.walletName, pass: passController.text)
          .then((value) async {
        ...
        if (value == 'OK') {
          ...
          if (sharedPrefs.containsKey('pass')) {
            appController.password.value = (sharedPrefs.getString('pass'))!;
