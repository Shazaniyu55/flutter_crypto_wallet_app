...
class _ChangePasswordState extends State<ChangePassword> {
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      CommonWidgets()
                          .appBar(hasBack: true, title: 'Change Password'),
                    ],
                  ),
                ),
                Container(
                  ...
                  constraints: BoxConstraints(
                      minHeight: Get.height - 100, minWidth: Get.width),
                  child: Column(
  ...
  verifyFields() {
    if (oldPassController.text.trim() == '') {
      ...
      ApiService()
          .changePass(
              pass: newPassController.text, oldPass: oldPassController.text)
          .then((value) {
        if (value == 'OK') {
          UtilService()
              .showToast('Updated Successfully', color: greenCardColor.value);
          Get.back();
        }
      });
    }
