// ignore_for_file: unused_field, prefer_final_fields, unnecessary_new, unnecessary_string_interpolations, prefer_is_empty, prefer_interpolation_to_compose_strings, use_super_parameters

import 'package:benex/UI/common_widgets/commonWidgets.dart';
...
class _HistoryState extends State<History> {
    ...
    Future.delayed(const Duration(milliseconds: 200), () {
      ApiService()
          .getTransactions(
              limit: 10,
              offset: 0,
              type: historyFilters[appController.selectedTabIndex1.value])
          .then((value) {
        if (value == 'OK') {
  ...
  onLoad() async {
    ApiService()
        .getTransactions(
            limit: 10,
            offset: appController.allTransactionsList.length,
            type: historyFilters[appController.selectedTabIndex1.value],
            method: 'add')
        .then((value) {
      if (value == 'OK') {
                            ...
                            child: InkWell(
                              onTap: () {
                                ...
                                if (index == 0) {
                                  ...
                                  coinID.value = appController.userBalance.value
                                      .balance![index - 1].coinId!;
                                }
                                if (mounted) {
                                  setState(() {});
                                  getHistory();
                    ...
                    SizedBox(
                      ...
                      child: SmartRefresher(
                        ...
                        child: appController.getTransactionsLoader.value == true
                            ...
                            : appController.getTransactionsLoader.value ==
                                        false &&
                                    appController.allTransactionsList.length ==
                                        0
                                ? Center(
                                    child: Text(
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      return historyContainer(
                                          ...
                                          index: index,
                                          type: appController
                                              .allTransactionsList[index].type,
                                          onTap: () {
                                            //Get.to(CoinHistory());
                                          });
                                    },
                  ...
                  Container(
                      ...
                      child: type == 'Swap'
                          ? Icon(
                              ...
                              size: 15,
                              color:
                                  type == 'Withdraw' || type == 'Withdraw Fiat'
                                      ? iconUpColor
                                      : iconDownColor,
                            )
                          : Icon(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      if (type != 'Withdraw Fiat')
                        Text(
                          type != 'Withdraw'
                              ? "${(appController.allTransactionsList[index].fromAddress == null ? '' : appController.allTransactionsList[index].fromAddress!.substring(0, 5) + '...' + appController.allTransactionsList[index].fromAddress!.substring(appController.allTransactionsList[index].toAddress!.length - 4))}"
                              : "${appController.allTransactionsList[index].toAddress!.substring(0, 5) + '...' + appController.allTransactionsList[index].toAddress!.substring(appController.allTransactionsList[index].toAddress!.length - 4)}",
                          style: TextStyle(
                              fontFamily: 'sfpro',
                              fontStyle: FontStyle.normal,
                              fontWeight: FontWeight.w400,
                  ...
                  Text(
                    '${dateFormatting.format(
                      DateTime.fromMillisecondsSinceEpoch(DateTime.parse(
                              appController
                                  .allTransactionsList[index].createdAt!)
