// ignore_for_file: empty_catches, unused_local_variable, use_super_parameters

import 'package:benex/UI/pages/changePassword/changePassword.dart';
import 'package:benex/UI/pages/userDetails/userDetails.dart';
import 'package:benex/models/userModel.dart';
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      await prefs.setBool(
                          'isDarkMode', appController.isDark.value);
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            "Logout",
                            style: TextStyle(
                                fontSize: 20, color: primaryColor.value),
                          ),
                          const SizedBox(
                            width: 5,
                          ),
