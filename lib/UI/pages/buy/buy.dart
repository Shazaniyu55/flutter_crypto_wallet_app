// ignore_for_file: unused_local_variable, unnecessary_null_comparison, unnecessary_import, no_leading_underscores_for_local_identifiers, prefer_typing_uninitialized_variables, unnecessary_new, deprecated_member_use

import 'dart:async';
import 'dart:convert';

import 'package:benex/models/coinPriceData.dart';
...
class _BuyState extends State<Buy> {
  ...
  onTapBuy() {
    if (amountController.text.isEmpty) {
      ...
      Get.to(OpenLink(url: url, fromPage: ''), duration: const Duration(milliseconds: 300), transition: Transition.rightToLeft);
    }
  }
  ...
  late Timer searchOnStoppedTyping = new Timer(const Duration(milliseconds: 1), () {});
