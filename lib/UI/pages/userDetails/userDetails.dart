                          ...
                          ? Container(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color:
                                        primaryColor.value.withOpacity(0.20)),
                                child: CachedNetworkImage(
                                  imageUrl:
                                      appController.user.value.image ?? '',
    ...
    if (nameController.text.trim() == '') {
      ...
      if (_image.path == '') {
        ApiService()
          ...
          if (value == 'OK') {
            await ApiService().getLoggedInUser().then((value) {
              Get.back();
              UtilService().showToast('Successfully Updated!',
        ...
        await UploadMediaService()
            .uploadMediaFile(context, 'profilePics', _image, 'image')
            .then((value) {
