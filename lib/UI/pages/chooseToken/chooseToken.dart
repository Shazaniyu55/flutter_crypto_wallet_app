...
class _ChooseTokenState extends State<ChooseToken> {
  ...
  onLoad() {
    ApiService().getAllCoins(
        limit: 10, offset: appController.allCoinsList.length, method: 'add');
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, i) {
                            bool inc = (appController.userBalance.value
                                            .balance?[i].priceChange ??
                                        0) >
                                    0
                                ? true
                                : false;
  ...
  Widget _coinRow(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.only(top: 12, bottom: 5, right: 12),
        child: Center(
          child: Row(
